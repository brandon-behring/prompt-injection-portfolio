...
| M2+ (carrier arc → Lane 2) | — | `v0.2.0` | carrier SMALL-THROUGHOUT (pre-flight done); cross-family SURVIVES; C1 carrier/table training NOT-CLOSED — the residual table wall is data-resistant at the ceiling (ADR-055 amendments, 2026-06-11); next: C2 mechanism probe (pre-reg drafted) |
